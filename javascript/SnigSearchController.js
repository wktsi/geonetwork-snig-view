(function() {
    goog.provide('snig_search_controller');
    goog.require('gn_searchsuggestion_service');
    goog.require('snig_searchsuggestion_service');
    ...
    var module = angular.module('snig_search_controller', [
        'ui.bootstrap.typeahead',
        'gn_searchsuggestion_service',
        'snig_searchsuggestion_service',
     ...
     */
    module.controller('SnigSearchController', [
        '$scope',
        '$q',
        '$http',
        'gnHttp',
        ...
        'gnSearchSettings',
        'gnUrlUtils',
        function($scope, $q, $http, gnHttp, suggestService, snigSuggestService,
            ...
            $scope.getAnySuggestions = function(val) {
                return snigSuggestService.getAnySuggestions(val);
            };
                ...
                remote: {
                   filter: function(data) {
                    ...
                    data.forEach(function(item) {
                      datum.push({
                          id: item.value,
                          name: item.values.por || item.values.eng,
                          desc: item.definitions.por || item.definitions.eng
                        });
                      });
                      return datum;
                    },
