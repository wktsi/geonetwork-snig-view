(function(){
    goog.provide('snig_multi_location_directive');

    goog.require('gn_thesaurus_service');

    var module = angular.module('snig_multi_location_directive', ['gn_thesaurus_service']);

    module.directive('snigMultiLocation', ['gnGlobalSettings', 'gnThesaurusService', '$location',
